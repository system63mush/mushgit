...
import com.mushsoft.menu.DesktopMenu;
import com.mushsoft.menu.DesktopMenu.onChangeViewListener;
import com.mushsoft.menu.Home;
import com.mushsoft.menu.UserMenu;
import com.mushsoft.utils.ActivityForResultUtil;
import com.mushsoft.utils.PhotoUtil;
import com.mushsoft.utils.ViewUtil;
import com.mushsoft.view.FlipperLayout;
import com.mushsoft.view.FlipperLayout.OnOpenListener;
import com.mushsoft.view.FlipperLayout.onUgcDismissListener;
import com.mushsoft.view.FlipperLayout.onUgcShowListener;
...
public class MainActivity extends BaseActivity implements OnOpenListener {
	 ...
	 * 菜单界面
	 */
	private DesktopMenu mDesktop;
	/**
	 * 用户首页界面
	 */
	private UserMenu mUserInfo;
	/**
	 * 内容首页界面
	 */
	private Home mHome;
...
//	private Lbs mLbs;
	...
	protected void onCreate(Bundle savedInstanceState) {
		 ...
		 */
		mDesktop = new DesktopMenu(this, this, mKXApplication);
	...
	private void setListener() {
		...
		mDesktop.setOnChangeViewListener(new onChangeViewListener() {
			...
			public void onChangeView(int arg0) {
				...
				case ViewUtil.USER:
					if (mUserInfo == null) {
						mUserInfo = new UserMenu(MainActivity.this,
