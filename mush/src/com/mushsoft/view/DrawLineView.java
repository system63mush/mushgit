...
import com.mushsoft.bean.Point;
import com.mushsoft.utils.Constant;
import com.mushsoft.utils.PreferenceUtils;

public class DrawLineView extends View {
	private final String TAG = "Drawl";
	...
	public DrawLineView(Context context, List<Point> list,GestureCallBack callBack) {
		super(context);
	...
	public boolean onTouchEvent(MotionEvent event) {
		String passWord = PreferenceUtils.getString(getContext(), Constant.PREFERENCE_HAND_PASSWORD, "");
		...
		case MotionEvent.ACTION_UP:// 当手指抬起的时候
			...
			if(passWord.equals(passWordSb.toString())){
				...
				PreferenceUtils.putString(getContext(), Constant.PREFERENCE_HAND_PASSWORD, passWordSb.toString());
				callBack.setSuccess();
			}else{
				//用户绘制的密码与传入的密码不同。
				callBack.checkedFail();
			}
			Log.e(TAG, passWordSb.toString()+"--");
