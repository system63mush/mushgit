...
import com.mushsoft.utils.ScreenUtils;
...
public class ContentView extends ViewGroup {
	...
	private DrawLineView drawPointView;
	...
	public ContentView(Context context,GestureCallBack callBack) {
		...
		addChild();
		// 初始化一个可以画线的view
		drawPointView = new DrawLineView(context, list,callBack);
	}
	...
	public void setParentView(ViewGroup parent){
		...
		drawPointView.setLayoutParams(layoutParams);

		parent.addView(drawPointView);
		parent.addView(this);
